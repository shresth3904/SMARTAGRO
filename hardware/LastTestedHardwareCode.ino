...
// Easily change these without editing code logic
String wifiSSID     = "";      // <-- leave blank for now
String wifiPassword = "";
String serverIP     = "";      // only the IP, like "192.168.1.10"
String serverPort   = "5000";

// Build full URLs only if serverIP is set
...
void loop() {
  ...
  Serial.printf("Water: %d%% | Soil1: %d%% | Soil2: %d%% | Avg Soil: %d%% | Hum: %.1f%% | Temp: %.1f°C\n",
